...
This repository explores **training data memorization in language models** by reproducing and extending extraction and **membership inference** techniques introduced by *Carlini et al., “Extracting Training Data from Large Language Models” (2021)*.  
Using a fine-tuned GPT-2 model with planted secrets, the project demonstrates how structured prompting, controlled decoding, and perplexity-based analysis can surface memorized training examples.
...
- Extracts **planted secrets** and **out-of-distribution passages** from a fine-tuned GPT-2 model
- Uses **membership inference via perplexity** to assess whether extracted text is likely memorized
- Replicates core findings from prior memorization literature in a **controlled experimental setting**
